...
console.log(filterUnfundedOnly(GAMES_JSON));
...
console.log(filterFundedOnly(GAMES_JSON));
...
console.log(showAllGames(GAMES_JSON));
...
const unfundedDescription = `A total of $${ totalRaised.toLocaleString() ?totalRaised.toLocaleString():"$0"} has been raised for ${totalGames?totalGames:"0"} games. Currently, ${unfundedGamesCount ? unfundedGamesCount : 'no'}  games remain unfunded. We need your help to fund these amazing games!`;
...
// use destructuring and the spread operator to grab the first and second games
 const [firstGame, secondGame, ...resfOfGames]= sortedGames;

 console.log(sortedGames);
 console.log(firstGame);
 console.log(resfOfGames);

// create a new element to hold the name of the top pledge game, then append it to the correct element
const topPledgeGame = document.getElementById("top-pledged");
const topFundedGame = firstGame.name;
topPledgeGame.innerHTML = `<p> ${topFundedGame}</p>`;
// do the same for the runner up item
const runnerUp = document.getElementById("runner-up");
const secondBest = secondGame.name;
runnerUp.innerHTML = `<p> ${secondBest}</p>`;
